    ...
    <div className="home-container1">
      ...
      <section className="home-hero">
        <div className="home-heading10">
          <h1 className="home-header11">Testing Platform</h1>
          <span>
            <DateTimePrimitive
              format="DD/MM/YYYY"
              date="Sun Sep 01 2024 13:35:13 GMT-0700 (Pacific Daylight Time)"
            ></DateTimePrimitive>
          </span>
          <p className="home-caption10">
            The following content is a template used to test this site&apos;s
            functionality
          </p>
        </div>
